			...
			\begin{parts}
				...
				\part
					\begin{align*}
						...
						2s_n &= \frac{1}{0.2k+\frac{1-0.2k}{n}}\\
						\therefore \frac{2}{0.2+\frac{0.8}{n}} &= \frac{1}{0.2k+\frac{1-0.2k}{n}}\\
						0.4k+\frac{2-0.4k}{n} &= 0.2+\frac{0.8}{n}\\
						0.4kn+2-0.4k &= 0.2n+0.8\\
						0.4k(n-1) &= 0.2n-1.2\\
						\therefore k &= \frac{0.2n-1.2}{0.4(n-1)}\\
						k &= \frac{n-6}{2(n-1)},n>5
					\end{align*}
